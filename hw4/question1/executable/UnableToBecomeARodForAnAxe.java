...
/**
 * concrete class for nothing i have become
 */
public class UnableToBecomeARodForAnAxe extends IbrahimState {
    public UnableToBecomeARodForAnAxe(IbrahimYazici ibrahimYazici){
        super(ibrahimYazici);
    }
    @Override
